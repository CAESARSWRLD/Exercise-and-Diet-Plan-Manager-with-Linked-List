...
std::ifstream& operator>>(std::ifstream& input, DietPlan& plan)//overloaded string extraction:
{
...
std::ostream& operator<<(std::ostream& output, const DietPlan& plan)//overloaded string insertion:
{
